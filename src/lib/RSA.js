...
// export function. So use this export function to set the variable. DON'T JUST SET THE
// VALUE. USE THE export FUNCTION.
//
...
* in JavaScript.  The cryptographic export functions herein are used for encoding
...
* decryptedString.
*
* Note that the cryptographic export functions herein are complementary to those
...
export function RSAKeyPair(encryptionExponent, decryptionExponent, modulus, keylen)
/*
